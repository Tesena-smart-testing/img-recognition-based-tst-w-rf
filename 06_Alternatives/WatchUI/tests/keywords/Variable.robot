*** Variables ***
# ---------------------------------------- Basic set up ----------------------------------------------------------------
${URL}                          https://pypi.org/project/WatchUI/  # 404 page, but good enough to present image comparison functionality
${BROWSER}                      Chrome
${SF_OOUTPUTS}                  Outputs
${SSIM1.0}                      1.0
${SSIM0.95}                     0.95
...
${1IMAGE}                       Img/forpres1.png
${2IMAGE}                       Img/forpres2.png
...
${CS_NEWURL}                    https://pypi.org/project/WatchUI/#history

# ---------------------------------------- Comparing screen without Area ------------------------------------------------------------
${CSWA_NEWURL}                  https://pypi.org/project/WatchUI/#files
